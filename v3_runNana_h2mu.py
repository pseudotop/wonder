...
if not os.path.isdir("./h2mu_test"):
    os.mkdir("./h2mu_test")
os.chdir("./h2mu_test")
print "usage : python v3_runNana_h2mu.py [Realdata - On: '1', Off: '0'] [dataset location] [output filename]"
path = sys.argv[2]
if not path:
    print "please input dataset location."
    #path = "/cms/data/xrd/store/user/jlee/TTJets_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/cat74v2_RunIISpring15DR74-Asympt50ns_MCRUN2_74_V9A-v1/150713_164609/0000/"
...
if len(sys.argv)==3:
    ...
    print "file name = %s_%s" % (path_split[7],path_split[8])
    f_name = "%s_%s" % (path_split[7],path_split[8])   
